...
btnSi.addEventListener("click", function () {
  ...
  Swal.fire({
    position: "top-center",
    title: "Gracias por confiar en mi, soy el chico más feliz del mundo.. No te decepcionaré, te amo!!🥰",
  ...
  parrafo.textContent = "El reinicio de una hermosa historia ha comenzado... Juntos para toda la vida!!";
